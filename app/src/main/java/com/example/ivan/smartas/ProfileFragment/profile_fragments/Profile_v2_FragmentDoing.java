...
public class Profile_v2_FragmentDoing extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.profile_v2_doing, container, false);
        linearLayout = (LinearLayout) view.findViewById(R.id.profile_v2_doing_list);
        /*recyclerView = (RecyclerView) view.findViewById(R.id.profile_v2_doing_list);
