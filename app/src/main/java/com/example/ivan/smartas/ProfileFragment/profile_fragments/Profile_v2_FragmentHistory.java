...
public class Profile_v2_FragmentHistory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.profile_v2_history, container, false);
        linearLayout = (LinearLayout) view.findViewById(R.id.profile_v2_history_list);
        /*recyclerView = (RecyclerView) view.findViewById(R.id.profile_v2_history_list);
